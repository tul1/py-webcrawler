...
class WebCrawlerAsync(WebCrawlerService):
    ...
    async def run(self) -> str:
        """ Crawl the web """
        queue: List[WebNode] = [self._root_web] # potential refactor
        ...
        while queue:
            ...
            if current_web not in visited_webs:
                ...
                current_web.children = [WebNode(url=child_url) for child_url in await WebCrawlerAsync._get_embedded_web(current_web.url)] 
